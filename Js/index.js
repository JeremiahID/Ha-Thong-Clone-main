...
// FAVORITE TWICKING
const Svg = document.querySelector( '.dress-two');
var solid , outline;
...
Svg.addEventListener('click', ()=>{
   ...
   // CONDTIONAL STATEMENT TO TOGGLE THE STATE OF THE FLAG USING TENEARY OPERATOR!
    Svg.innerHTML = isSolid ? outline : solid;    

    isSolid = !isSolid; // SEETING THE FLAG TO TRUE / FALSE DEPENDING ON THE CURRENT STATE.
