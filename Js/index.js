...
var cartAddIcon = document.getElementsByClassName('cart-add-icon');// getting the container for the each cart items icon
...
function cartItemIcon(cartElement){
    ...
    // CONDTIONAL STATEMENT TO TOGGLE THE STATE OF THE FLAG USING TENEARY OPERATOR!
        cartElement.innerHTML = isCartSolid ? cartSolid : cartOutline;
